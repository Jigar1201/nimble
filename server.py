...
class FlagVideoStreamTrack(VideoStreamTrack):
        ...
        data_bgr = numpy.hstack(
            [
                self._create_rectangle(
                    width=213, height=500, color=(255, 0, 0)
                ),  # blue
                self._create_rectangle(
                    width=214, height=500, color=(255, 255, 255)
                ),  # white
                self._create_rectangle(width=213, height=500, color=(0, 0, 255)),  # red
            ]
        )
    ...
    async def recv(self):
        ...
        if(self.cy>=(self.height-self.radius-1) or self.cy<=(self.radius)):
        ...
        image = cv2.circle(image, (self.cx,self.cy), self.radius, (255,255,0), -1)
        ...
        self.counter += 1
        print("self.counter sender:",self.counter)
        return frame
